...
public:
    ...
    std::pair<Path, Path> bestPathDriveWalk(Graph<int> *g, const int &start, const int &end, int max_walking, bool alternative, const std::vector<int> &avoid_nodes, const std::vector<std::pair<int, int>> &avoid_edges, std::string message);
